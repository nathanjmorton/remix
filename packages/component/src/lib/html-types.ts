...
import type { StyleProperties, EnhancedStyleProperties } from './style/index.ts'
...
type NormalizeOnProp<P, T extends EventTarget> = P extends { on?: any }
  ? { [K in keyof P as K extends 'on' ? never : K]: P[K] } & {
      on?: EventListeners<T>[] | undefined
    }
  : P
...
export interface HTMLProps<Target extends EventTarget = EventTarget> extends AriaProps {
  ...
  on?: EventListeners<Target> | EventListeners<Target>[] | undefined
