...
describe('vnode rendering', () => {
  ...
  describe('Catch', () => {
    ...
    // FIXME: Interactions handleError
    it.skip('uses nearest Catch on event errors (nested boundaries)', () => {
      let container = document.createElement('div')
      let root = createRoot(container)
    ...
    // FIXME: Interactions handleError
    it.skip('preserves siblings when Catch trips and resets on parent re-render from events', () => {
      let container = document.createElement('div')
      document.body.appendChild(container)
      let root = createRoot(container)
    ...
    // FIXME: Interactions handleError
    it.skip('clears after an event error', () => {
      let container = document.createElement('div')
      let root = createRoot(container)
  ...
  describe('events integration', () => {
    ...
    // FIXME: Interactions handleError
    it.skip('renders catch fallback with event errors', () => {
      let container = document.createElement('div')
      let root = createRoot(container)
